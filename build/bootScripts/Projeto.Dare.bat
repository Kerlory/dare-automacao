...
set JARPATH=%APP_HOME%\lib\Projeto.Dare-1.0.0.jar

@rem Execute Projeto.Dare
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %PROJETO_DARE_OPTS%  -jar "%JARPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%PROJETO_DARE_EXIT_CONSOLE%" exit 1
exit /b 1
